      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 w-full max-w-lg animate-fadeIn max-h-[80vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            {([
              { type: "PRIVATE", icon: "🔒", label: "Приватный", desc: "Только вы можете видеть файл" },
              { type: "LINK_ACCESS", icon: "🔗", label: "По ссылке", desc: "Знает ссылку — может скачать" },
              { type: "PUBLIC", icon: "🌐", label: "Публичный", desc: "Любой может найти и скачать" },
